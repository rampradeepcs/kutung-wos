function makeTimer() {
  ...
  $("#days").html(
    "<h4 class='m-0 mb-3 common-head'>" + days + "</h4><span>Days</span>"
  );
  $("#hours").html(
    "<h4 class='m-0 mb-3 common-head'>" + hours + "</h4><span>Hours</span>"
  );
  $("#minutes").html(
    "<h4 class='m-0 mb-3 common-head'>" + minutes + "</h4><span>Mins</span>"
  );
  $("#seconds").html(
    "<h4 class='m-0 mb-3 common-head'>" + seconds + "</h4><span>Secs</span>"
  );
}
...
$(document).ready(function () {
  ...
  rcoOwl.owlCarousel({
    ...
    navText: [
      '<div class="arrow-icon"><svg width="100%" height="100%" viewBox="0 0 32 32" fill="none"><path d="M20 24L12 16L20 8" stroke="#347AF4" stroke-width="1.5"/></svg></div>',
      '<div class="arrow-icon"><svg width="100%" height="100%" viewBox="0 0 32 32" fill="none"><path d="M12 24L20 16L12 8" stroke="#347AF4" stroke-width="1.5"/></svg></div>',
    ],
  });
  /*Recent Launch Carousel*/
